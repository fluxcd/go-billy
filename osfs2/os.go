...
// Package osfs2 provides a billy filesystem for the OS, which restricts write
// operations to descending locations from the current working dir.
package osfs2
...
// changes in behaviour when compared to osfs:
//
